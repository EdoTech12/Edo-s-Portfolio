function EmailButton() {
    return ( 
        <a href="mailto:edoardotesser.work@gmail.com">
            <svg class="text-blue-200 hover:text-cyan-300 w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
